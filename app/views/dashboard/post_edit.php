        ...
        <div class="row">
          <div class="col-12">
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <form role="form" action="<?= BASE_URL; ?>/admin/post/edit_process" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" placeholder="Enter ..." value="<?= $data['title']; ?>">
                  </div>
                  <div class="form-group">
                    <label>Textarea</label>
                    <textarea class="textarea" name="article" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?= $data['article']; ?></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
