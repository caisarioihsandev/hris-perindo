        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= BASE_URL; ?>/admin/user/edit_process" method="post" class="form-horizontal">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="pwd" name="pwd" value="<?= $data['password']?>">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="email1" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="email1" name="email1" value="<?= $data['email']?>">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
                <div class="card-footer">
                  <div class="row">
                    <div class="col-4" style="align-items: right;">
                      ...
                      <button type="submit" class="btn btn-info float-right">Edit User</button>  
                    </div>
